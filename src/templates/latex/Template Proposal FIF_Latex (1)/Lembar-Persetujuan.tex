...
{ Proposal ini diajukan sebagai usulan pembuatan tugas akhir pada\\ Program Studi Sarjana \Prodi\\ Fakultas Informatika Universitas Terakreditasi}\\

\vspace{0.5cm}

{Jakarta, \Tanggal\quad \Bulan \quad \Date}\\
{Menyetujui}\\
